...
class AppHorizontalListAdapter : RecyclerView.Adapter<RecyclerView.ViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
        val item = when (viewType) {
            0 -> AppsOverviewHorizontalItemFactory().dispatchCreateItem(parent)
            1 -> ListSeparatorHorizontalItemFactory().dispatchCreateItem(parent)
            2 -> AppHorizontalItemFactory().dispatchCreateItem(parent)

...
import com.github.panpf.recycler.sticky.sample.databinding.ItemAppBinding
import me.panpf.sketch.shaper.RoundRectImageShaper
import me.panpf.sketch.uri.AppIconUriModel

class AppItemFactory : BindingItemFactory<AppInfo, ItemAppBinding>(AppInfo::class) {
    ...
    override fun initItem(
        ...
        binding.appItemIconImage.options.shaper =

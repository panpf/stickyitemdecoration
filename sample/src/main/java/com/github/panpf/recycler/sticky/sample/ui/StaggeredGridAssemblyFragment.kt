...
class StaggeredGridAssemblyFragment : BaseBindingFragment<FragmentRecyclerBinding>() {

    companion object {
        fun create(stickyItemClickable: Boolean = false) = StaggeredGridAssemblyFragment().apply {
